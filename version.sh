...
#https://github.com/TexasInstruments/ti-linux-firmware/compare/11.02.11...11.02.12
#https://forgejo.gfnd.rcn-ee.org:3000/TexasInstruments/ti-linux-firmware/compare/11.02.11...11.02.12
TI_FIRMWARE_GIT="${TI_FIRMWARE_GIT:-https://github.com/TexasInstruments/ti-linux-firmware.git}"
TI_FIRMWARE="${TI_FIRMWARE:-11.02.12}"

#https://github.com/TrustedFirmware-A/trusted-firmware-a.git
#https://github.com/TrustedFirmware-A/trusted-firmware-a/compare/lts-v2.14.1...lts-v2.14.2
#https://forgejo.gfnd.rcn-ee.org:3000/mirror/trusted-firmware-a/compare/lts-v2.14.1...lts-v2.14.2
