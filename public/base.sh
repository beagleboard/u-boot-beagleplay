...
wget https://github.com/beagleboard/u-boot-beagleplay/releases/download/TAG/tiboot3.bin
wget https://github.com/beagleboard/u-boot-beagleplay/releases/download/TAG/tispl.bin
wget https://github.com/beagleboard/u-boot-beagleplay/releases/download/TAG/u-boot.img
